...
<main class="registrasi">
    <div class="container-fluid">
        <div class="row row-cols-md-2 row-cols-1 align-items-center" style="height:100vh; width:100vw;overflow:hidden">
            <div class="col registrasi__form" style='padding: 3rem 0 3rem 6rem'>
                    ...
                    <div class="registrasi__formContent">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="group__form d-flex justify-content-between mb-3 align-items-center">
                                ...
                                <a href="{{ route('password.request') }}" class="forgot__password">Forgot your
                                    password?</a>
                                @endif
                            </div>
                            <div class="row row-cols-1 gy-3">
                                <div class="col-lg-4">
                                    <button type="submit" class="btn text-white"
                                        style="border-radius:10px;width: 45% !important;background-color:#ff8741;font-size: 1rem;">Sign
                                        In</button>
                                </div>
                        </form>
                    </div>
        ...
        <div class="col registrasi__gambar p-5">
