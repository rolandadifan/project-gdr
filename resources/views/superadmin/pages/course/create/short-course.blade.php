...
var detail_max = 1; //initlal text box count
var info_max = 1; //initlal text box count

$(add_detail_btn).click(function(e) { //on add input detail_btn click
    e.preventDefault();
    if (detail_max < max_fields) { //max input box allowed
        detail_max++; //text box increment
...
$(add_info_btn).click(function(e) { //on add input detail_btn click
    e.preventDefault();
    if (info_max < max_fields) { //max input box allowed
        info_max++; //text box increment
...
>>>>>>> b9ec504623cc66eaba7e95b775b6a689c7233956
@endpush