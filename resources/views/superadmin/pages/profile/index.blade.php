...
<div class="container-fluid">
    ...
    <div class="card py-3 px-3">
        ...
        <form action="{{ route('profile.admin.update') }}" method="POST" class="profile-data"
            ...
            <div class="row d-flex">
                <div class="">
                    <div class="image-profile">
                        <div class="d-flex flex-column">
                            ...
                            <img src="{{ asset('assets/images/avatar-default.png') }}" width="200" class="rounded ml-3"
                                alt="profile">
                            @else
                ...
                <div class="mr-1">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control profile-input" name="name" id=""
                            value="{{ Auth()->user()->name }}">
                    </div>
                    <div class="form-group">
                        <label for="name">Email</label>
                        <input type="email" class="form-control profile-input" name="email" id=""
                            value="{{ Auth()->user()->email }}">
                    </div>
                    <div class="form-group">
                        <label for="name">No.Hp</label>
                        <input type="text" class="form-control profile-input" name="telephone" id=""
