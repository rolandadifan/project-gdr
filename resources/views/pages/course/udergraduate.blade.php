...
@include('icon')
  <main>
        <div class="container-fluid">
            <div id="undergraduateCourse" class="p-2">
                <div class="undergraduateCourse__header">
                    <h2>International Programs</h2>
                    <h4>Undergraduate Courses</h4>
                </div>
                <div class="undergraduateCourse__context">
                    <div class="container">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link active" id="diploma-tab" data-bs-toggle="tab"
                                    data-bs-target="#diploma" type="button" role="tab" aria-controls="diploma"
                                    aria-selected="true">
                                    Diploma
                                </button>
                                <button class="nav-link" id="bachelor-degree-tab" data-bs-toggle="tab"
                                    data-bs-target="#bachelor-degree" type="button" role="tab"
                                    aria-controls="bachelor-degree" aria-selected="false">
                                    Bachelor Degree
                                </button>
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="bachelor-degree" role="tabpanel"
                                aria-labelledby="bachelor-degree-tab">
                                <div class="card">
                                    <div class="cardBachelor__header">
                                        <h2>BACHELOR DEGREE (INTERNATIONAL)</h2>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="item1">
                                                <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#computerSystems"
                                                    aria-expanded="false" aria-controls="computerSystems">
                                                    Computer Systems
                                                </button>
                                            </h2>
                                            <div id="computerSystems" class="accordion-collapse collapse p-md-3"
