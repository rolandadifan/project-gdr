        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="form-tab" data-bs-toggle="tab" data-bs-target="#form" type="button"
                    role="tab" aria-controls="form" aria-selected="true">FORM</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="document-tab" data-bs-toggle="tab" data-bs-target="#document" type="button"
                    role="tab" aria-controls="document" aria-selected="false">DOCUMENT</button>
            </li>
        </ul>
                        ...
                        <div class="row row-cols-md-2 row-cols-1">
                            <div class="col">
                                ...
                                <div class="form__study--permitPeriod">
                                    ...
                                    <div class="mb-3">
                                        <label for="startLearning" class="form-label">Start
                                            Learning<span>*</span></label>
                                        <input type="date" class="form-control" id="startLearning" name="startLearning">
                                    </div>
                                    <div class="mb-3">
                                        <label for="lengthStudy" class="form-label">Length of Study
                                        ...
                                        <div class="row row-cols-md-2 row-cols-1">
                                            <div class="col">
                                                ...
                                                <input type="date" class="form-control" placeholder="First name"
                                                    aria-label="First name" id="formDate" name="formDate">
                                            </div>
                                            <div class="col">
                                ...
                                <div class="form__funding">
                                    ...
                                    <div class="mb-3">
                                        <label for="scholarshipProvided" class="form-label">Scholarship
                                            Provided<span>*</span></label>
                                        <input type="text" class="form-control" id="scholarshipProvided"
                                            name="scholarshipProvided">
                                        <div id="scholarshipHelp" class="form-text">For example: Parents, Government,
                                            Campus, etc.</div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="positionGuarantor" class="form-label">Position
                                            Guarantor<span>*</span></label>
                                        <input type="text" class="form-control" id="positionGuarantor"
                                            name="positionGuarantor">
                            ...
                            <div class="col">
                                ...
                                <div class="form__placeResidenceIndonesia">
                                    ...
                                    <div class="mb-3">
                                        <label for="provinceIndonesia" class="form-label">Province /
                                            State<span>*</span></label>
                                        <input type="text" class="form-control" id="provinceIndonesia"
                                            name="provinceIndonesia">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="postCodeIndonesia" class="form-label">Post
                                ...
                                <div class="form__passport">
                                    ...
                                    <div class="mb-3">
                                        <div class="row row-cols-md-2 row-cols-1">
                                            <div class="col">
                                                <label for="dateOfFilling" class="form-label">Date of
                                                    filling<span>*</span></label>
                                                <input type="date" class="form-control" placeholder="First name"
                                                    aria-label="First name" id="dateOfFilling" name="dateOfFilling">
                                            </div>
                                            <div class="col">
                                                <label for="expDate" class="form-label">Expiration
                    ...
                    <div class="disclaimer__lists">
                        ...
                        <div class="disclaimer__list--two">
                            ...
                            <p>
                                ...
                                Gunadarma through email:<a href="#">intloffoce.ud@gmail.com</a> with <span>maximum of 2
