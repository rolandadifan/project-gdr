export function getDisplay() {
    const appNewBtn =
        document.querySelector("#btnNewApp") === null
            ? ""
            : document.querySelector("#btnNewApp");
    const displayNewApp =
        document.querySelector("#startNewApp") === null
            ? ""
            : document.querySelector("#startNewApp");
...
export function getDegreeOrNon() {
    const degreeRadio =
        document.querySelector("#degree") === null
            ? ""
            : document.querySelector("#degree");
    const nonDegreeRadio =
        document.querySelector("#nonDegree") === null
            ? ""
            : document.querySelector("#nonDegree");
    const nextBtn =
    ...
    for (const radioBtn of radiosBtn) {
        ...
        radioBtn.addEventListener("click", () => {
            if (radioBtn.value === "nonDegree") {
                document
                    .querySelector(".nonDegreePermission")
